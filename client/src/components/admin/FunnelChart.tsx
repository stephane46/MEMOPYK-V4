...
export function FunnelChart() {
  ...
  console.log('FunnelChart render - data:', JSON.stringify(data));
  console.log('FunnelChart render - data.plays:', data?.plays);
  ...
  console.log('FunnelChart rows:', JSON.stringify(rows));
