                      ...
                      >
                        ...
                        <div className="relative overflow-hidden rounded-xl transition-all duration-500 aspect-square">
                          <div className="h-full flex flex-col px-2 pt-0 pb-2">
                            ...
                            <div className="text-center flex flex-col" style={{ height: 'calc(100% - 120px)', position: 'relative' }}>
                        ...
                        <div className="text-center" style={{ paddingTop: '60px', paddingBottom: '16px', paddingLeft: '16px', paddingRight: '16px' }}>
