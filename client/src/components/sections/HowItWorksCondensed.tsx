              ...
              <div key={step.number} className="text-center group">
                ...
                <div className={`card-flip-container ${isFlipped ? 'flipped' : ''} rounded-2xl mb-4`}>
                  <div className="card-flip-inner">
                    ...
                    <div className="card-back shadow-lg hover:shadow-2xl rounded-2xl overflow-hidden border border-gray-200 relative">
                      
                      {/* Image with gradient overlay - SAME SIZE AS FRONT */}
                      <div className="relative overflow-hidden rounded-xl transition-all duration-500 aspect-square">
                        <img 
                          src={step.image} 
                          alt={language === 'fr-FR' ? step.titleFr : step.titleEn}
                                ...
                                <ul className="space-y-2 text-left">
                                  {step.bullets.map((bullet, idx) => (
                                    <li key={idx} className="flex items-start space-x-2">
                                      <span className="text-memopyk-orange mt-0.5">•</span>
                                      <span className="text-sm leading-relaxed">
                                        {language === 'fr-FR' ? bullet.textFr : bullet.textEn}
                                      </span>
                                    </li>
                                  ))}
                                </ul>
                      ...
                      {/* Title inside card - WHITE AREA BELOW IMAGE - SAME AS FRONT */}
