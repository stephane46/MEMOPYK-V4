      ...
      <div className="absolute inset-0 flex items-center justify-center text-center text-white px-3 sm:px-6 lg:px-8">
        <div className="max-w-7xl w-full">
          ...
          <div className="flex justify-center items-center">
            <Button 
              size="lg" 
              className="inline-flex items-center gap-3 bg-gradient-to-r from-memopyk-orange to-memopyk-orange hover:from-memopyk-orange hover:to-memopyk-sky-blue text-white px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl cursor-pointer"
              onClick={() => {
