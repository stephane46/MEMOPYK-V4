...
export function HowItWorksSection() {
  ...
  return (
    <section id="how-it-works" className="pt-2 pb-2 bg-gradient-to-br from-white to-memopyk-sky-blue/10 border-4 border-blue-500">
            ...
            return (
              <div key={step.number} className="h-full">
                ...
                <div className={`relative bg-gradient-to-br from-memopyk-dark-blue via-memopyk-navy to-memopyk-dark-blue rounded-3xl shadow-2xl text-center group hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-2 z-10 h-full flex flex-col p-4 sm:p-6 lg:p-8 ${
                  ...
                  {/* Sub Description - Fixed at bottom with flexible height */}
                  <div className="flex-shrink-0 pt-4 border-t border-memopyk-cream/20 min-h-[120px] flex flex-col items-center justify-start">
