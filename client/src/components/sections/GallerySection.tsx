                    ...
                    <div className="aspect-[3/2] bg-gray-100 dark:bg-gray-700 relative overflow-hidden rounded-t-2xl">
                      {thumbnailUrl ? (
                        ...
                        <div className="w-full h-full relative">
                          ...
                          {getItemPrice(item) && (
                            <div 
                              className="absolute bottom-2 sm:bottom-4 right-2 sm:right-4 text-white px-2 sm:px-4 py-1 sm:py-2 rounded-full text-xs sm:text-sm font-bold shadow-lg"
                              style={{ 
                                backgroundColor: '#D67C4A !important',
                                backgroundImage: 'linear-gradient(135deg, #D67C4A 0%, #D67C4A 100%) !important',
