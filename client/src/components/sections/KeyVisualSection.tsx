          ...
          <div className="space-y-6 sm:space-y-8 lg:space-y-10 order-2 lg:order-none">
            ...
            <div className="text-lg sm:text-xl lg:text-2xl text-memopyk-navy leading-relaxed space-y-3 sm:space-y-2">
              {language === 'fr-FR' ? (
                <>
                  <div 
                    className={`flex items-center gap-3 bg-white/60 backdrop-blur-sm rounded-xl px-4 py-3 border border-memopyk-sky-blue/30 shadow-lg w-[560px] max-w-full transform transition-all duration-1000 hover:scale-105 hover:bg-white/80 hover:shadow-xl ${
                ...
                <>
                  <div 
                    className={`flex items-center gap-3 bg-white/60 backdrop-blur-sm rounded-xl px-4 py-3 border border-memopyk-sky-blue/30 shadow-lg w-[480px] max-w-full transform transition-all duration-1000 hover:scale-105 hover:bg-white/80 hover:shadow-xl ${
                      isVisible ? 'translate-x-0 opacity-100' : '-translate-x-96 opacity-0'
                    }`}
                    style={{ transitionDelay: '1200ms' }}
                  >
            ...
            <div className="relative mt-8 max-w-2xl mx-auto">
              ...
              <div className="bg-memopyk-sky-blue/20 border-2 border-memopyk-dark-blue rounded-xl px-5 py-5 shadow-lg relative overflow-hidden transform hover:scale-[1.02] transition-all duration-500">
