          ...
          <div className="space-y-6 sm:space-y-8 lg:space-y-10 order-2 lg:order-none">
            ...
            <div className="text-xl sm:text-2xl lg:text-3xl text-memopyk-navy leading-relaxed space-y-3 sm:space-y-2">
              {language === 'fr-FR' ? (
                <>
                  <div 
                    className={`flex items-center gap-3 bg-white/60 backdrop-blur-sm rounded-xl px-4 py-3 border border-memopyk-sky-blue/30 shadow-lg w-[520px] max-w-full transform transition-all duration-1000 hover:scale-105 hover:bg-white/80 hover:shadow-xl ${
