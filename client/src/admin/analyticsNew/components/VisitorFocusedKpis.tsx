        ...
        >
          <div className="bg-white rounded-lg shadow-xl max-w-4xl max-h-[90vh] overflow-hidden relative">
            ...
            <div className="overflow-y-auto max-h-[70vh] px-6 pb-6 pt-0">
              ...
              <div className="-mx-6 mb-6 mt-[-1px] p-4 bg-blue-50 border border-blue-200 rounded-lg">
      ...
      {isUniqueVisitorsModalOpen && (
        ...
        >
          <div className="bg-white rounded-lg shadow-xl max-w-4xl max-h-[90vh] overflow-hidden relative">
            ...
            <div className="overflow-y-auto max-h-[70vh] px-6 pb-6 pt-0">
              {/* Data Source Explanation Header */}
              <div className="-mx-6 mb-6 mt-[-1px] p-4 bg-green-50 border border-green-200 rounded-lg">
                <div className="space-y-2 text-sm">
      ...
      {isReturnVisitorsModalOpen && (
        ...
        >
          <div className="bg-white rounded-lg shadow-xl max-w-4xl max-h-[90vh] overflow-hidden relative">
            ...
            <div className="overflow-y-auto max-h-[70vh] px-6 pb-6 pt-0">
              {/* Data Source Explanation Header */}
              <div className="-mx-6 mb-6 mt-[-1px] p-4 bg-purple-50 border border-purple-200 rounded-lg">
                <div className="space-y-2 text-sm">
