    ...
    <div className="min-h-screen bg-[#F2EBDC]">
      ...
      <div className="container mx-auto px-4 pt-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div id="partner-list-container" className="flex flex-col gap-3 h-[588px] overflow-y-auto snap-y snap-mandatory partner-list-scrollbar p-0 pr-20" style={{ background: 'linear-gradient(to right, transparent calc(100% - 80px), #F2EBDC calc(100% - 80px))' }}>
            {isLoading ? (
