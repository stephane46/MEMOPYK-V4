...
## Recent Changes
- **Animated Card Width Optimization Complete (January 2025)**: Implemented language-specific width calculations for KeyVisual animated cards. French cards use 560px width (optimized for longest text "oubliés sur des disques durs..."), English cards use 420px width (optimized for longest text "forgotten on hard drives..."). This approach calculates optimal width independently for each language rather than applying a universal width, ensuring visual consistency within each language while maintaining proper text fitting.
