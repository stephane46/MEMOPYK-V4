...
- **Navigation System Migration**: Completed migration from anchor-based scrolling to dedicated page routing system. "How It Works" section moved to standalone URLs: `/fr-FR/comment-ca-marche` and `/en-US/how-it-works`.
